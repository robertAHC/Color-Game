...
// Function that changes the color to the pickedColr 
...
// Sections that change to easy, medium, and medium
easy.addEventListener("click", function() {
	easy.classList.add("selectedOption");
    medium.classList.remove("selectedOption");
...
medium.addEventListener("click", function() {
	medium.classList.add("selectedOption");
